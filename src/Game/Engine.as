package  Game
{
	...
	public class Engine
	{
		...
		public function Initialize(container:Sprite, x:int, y:int, debug:Boolean=false):void
		{
		...
		{
			var shader:Shader3D = new Shader3D( name, null, false, Shader3D.VERTEX_NORMAL );
			shader.filters.push( new TextureFilter(new Texture3D( src ) ) );
